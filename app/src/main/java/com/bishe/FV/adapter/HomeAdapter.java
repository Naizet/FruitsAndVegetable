...
import com.bishe.FV.entity.GridViewForScrollView;
...
public class HomeAdapter extends BaseAdapter {
    ...
    private List<Catagories.DataBean> foodDatas;

    public HomeAdapter(Context context, List<Catagories.DataBean> foodDatas) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        Catagories.DataBean dataBean = foodDatas.get(position);
        List<Catagories.DataBean.DataListBean> dataList = dataBean.getDataList();
