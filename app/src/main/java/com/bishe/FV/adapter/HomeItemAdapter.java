...
public class HomeItemAdapter extends BaseAdapter {
    ...
    private List<Catagories.DataBean.DataListBean> foodDatas;

    public HomeItemAdapter(Context context, List<Catagories.DataBean.DataListBean> foodDatas) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        Catagories .DataBean.DataListBean subcategory = foodDatas.get(position);
